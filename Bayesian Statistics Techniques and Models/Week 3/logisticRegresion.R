...
colMeans((X)) #calculating column means

apply(X,2,sd) #calculating column standard deviation

## Perform correlation on the variables
library("corrplot")
Cor = cor(dat)
...
##Using double exponential as prior for the coeffcients
...
#visual summary for posterior distribution
par(mfrow=c(3,2))
densplot(mod1_csim[,1:6],xlim=c(-3.0,3))
